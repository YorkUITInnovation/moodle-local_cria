...
$string['sync_ragflow_ui_note'] = 'Copy the Ragflow API key and tenant id from the Ragflow UI (or docker env) into Cria plugin settings to validate them here. Criadex and Criabot must use the same values in their docker.env files.';
