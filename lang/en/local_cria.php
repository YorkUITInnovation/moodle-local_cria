...
$string['provider_type_help'] = 'The backend API type used for routing requests to Criadex. This determines which API format is used for model operations. Currently supported: Azure OpenAI, Cohere. Additional types require corresponding Criadex backend routes.';
...
$string['sync_check_local_models_detail'] = 'Linked: {$a->linked}, unlinked: {$a->unlinked}, remote: {$a->remote}';
...
$string['sync_ragflow_ui_note'] = 'Tenant, API keys, knowledge bases, and graph dataset settings are managed in the Ragflow UI. Use this page for Cria ↔ Criadex ↔ Criabot sync.';
...
$string['ragflow_url_help'] = 'Base URL for Ragflow API reachability checks only. Tenant and API keys are managed in Ragflow, not here.';
