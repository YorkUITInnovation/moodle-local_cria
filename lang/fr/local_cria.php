...
$string['azure_endpoint_or_resource'] = 'URL du point de terminaison ou ressource';
$string['azure_endpoint_or_resource_help'] = 'Utilisez une URL de point de terminaison complète lorsque le fournisseur/la famille de modèles l\'exige (par exemple, endpoints Azure AI Foundry). Les anciennes valeurs de ressource restent prises en charge pour la compatibilité.';
...
$string['provider_type'] = 'Type de fournisseur';
$string['provider_type_help'] = 'Type d\'API backend utilisé pour router les requêtes vers Criadex. Détermine le format d\'API pour les opérations sur les modèles. Pris en charge : Azure OpenAI, Cohere, Ragflow et autres fournisseurs génériques.';
$string['model_type'] = 'Type de modèle';
$string['model_type_chat'] = 'Conversation';
$string['model_type_embedding'] = 'Embedding';
$string['model_type_rerank'] = 'Réordonnancement';
$string['providers'] = 'Fournisseurs';
$string['sync_status'] = 'État de synchronisation';
$string['sync_error_unknown'] = 'Erreur API inconnue';
$string['sync_models_failed'] = 'Impossible de synchroniser les modèles depuis Criadex. Vérifiez l\'URL Criadex et la clé API dans les paramètres du plugin.';
$string['sync_models_empty'] = 'Criadex n\'a renvoyé aucun modèle à synchroniser.';
$string['sync_models_success'] = 'Synchronisation des modèles terminée. Créés : {$a->created}, mis à jour : {$a->updated}, ignorés : {$a->skipped}, supprimés : {$a->removed}.';
$string['sync_dedupe_failed'] = 'Impossible de dédupliquer les modèles dans Criadex.';
$string['sync_dedupe_success'] = 'Déduplication des modèles terminée. {$a->remote} doublon(s) Criadex et {$a->local} doublon(s) Moodle supprimés.';
$string['sync_bot_missing_models'] = 'L\'enregistrement local du bot a réussi, mais l\'envoi vers Criabot a échoué : le modèle LLM ou d\'embedding n\'est pas lié à Criadex.';
$string['sync_bot_push_failed'] = 'Échec de l\'envoi de la configuration du bot vers Criabot.';
$string['sync_criabot_unreachable'] = 'Impossible de joindre Criabot. Vérifiez l\'URL Criabot dans les paramètres du plugin.';
$string['sync_check_criadex_url'] = 'URL Criadex configurée';
$string['sync_check_criabot_url'] = 'URL Criabot configurée';
$string['sync_check_api_key'] = 'Clé API Criadex configurée';
$string['sync_check_criadex_models'] = 'Registre de modèles Criadex accessible';
$string['sync_check_local_models'] = 'Tous les modèles locaux sont liés à Criadex';
$string['sync_check_local_models_detail'] = 'Liés : {$a->linked}, non liés : {$a->unlinked}, distants : {$a->remote}, utilisables : {$a->usable}';
$string['sync_check_bots_models'] = 'Tous les bots ont des liens de modèles valides';
$string['sync_check_bots_models_detail'] = '{$a} bot(s) sans lien de modèle Criadex';
$string['sync_check_criabot'] = 'API Criabot accessible';
$string['sync_check_criabot_ok'] = 'Criabot a répondu au contrôle de santé';
$string['sync_check_ragflow'] = 'API Ragflow accessible';
$string['sync_check_ragflow_ok'] = 'Contrôle de santé Ragflow réussi';
$string['sync_check_ragflow_http'] = 'Ragflow a renvoyé HTTP {$a}';
$string['sync_check_ragflow_credentials'] = 'Clé API et locataire Ragflow configurés';
$string['sync_check_ragflow_credentials_ok'] = 'Clé API acceptée par Ragflow. Locataire {$a->tenant} (doit aussi correspondre à RAGFLOW_TENANT_ID dans Criadex/Criabot).';
$string['sync_check_ragflow_credentials_skipped'] = 'Optionnel : ajoutez la clé API et le locataire Ragflow dans les paramètres du plugin pour les valider ici.';
$string['sync_check_ragflow_api_not_configured'] = 'La clé API Ragflow n\'est pas définie dans les paramètres du plugin.';
$string['sync_check_ragflow_api_ok'] = 'Ragflow a accepté la clé API configurée.';
$string['sync_check_ragflow_api_invalid'] = 'Ragflow a rejeté la clé API (HTTP {$a}).';
$string['sync_check_ragflow_api_http'] = 'Réponse API Ragflow inattendue (HTTP {$a}).';
$string['sync_check_ragflow_tenant_not_configured'] = 'Le locataire Ragflow n\'est pas défini dans les paramètres du plugin.';
$string['sync_check_ragflow_tenant_missing'] = 'Le locataire Ragflow est requis lorsqu\'une clé API est configurée.';
$string['sync_check_ragflow_tenant_invalid'] = 'Le locataire Ragflow doit être une chaîne hexadécimale de 32 caractères.';
$string['sync_check_ragflow_tenant_ok'] = 'Locataire configuré : {$a}';
$string['sync_check_unreachable'] = 'Service inaccessible ou réponse invalide';
$string['sync_check_label'] = 'Contrôle';
$string['sync_check_status'] = 'État';
$string['sync_check_detail'] = 'Détail';
$string['sync_status_ok'] = 'OK';
$string['sync_status_issue'] = 'Problème';
$string['sync_overall_healthy'] = 'Cria, Criadex et Criabot semblent synchronisés.';
$string['sync_overall_issues'] = 'Un ou plusieurs contrôles de synchronisation ont échoué. Consultez les détails ci-dessous.';
$string['sync_last_model_sync'] = 'Dernière synchronisation des modèles';
$string['sync_action_pull_models'] = 'Récupérer les modèles depuis Criadex';
$string['sync_action_reconcile_models'] = 'Réconcilier les modèles (récupération + suppression des obsolètes)';
$string['sync_action_dedupe_models'] = 'Dédupliquer les modèles';
$string['sync_action_repush_bots'] = 'Renvoyer tous les bots vers Criabot';
$string['sync_repush_bots_success'] = '{$a} configuration(s) de bot renvoyée(s) vers Criabot.';
$string['sync_repush_bots_partial'] = '{$a->pushed} bot(s) renvoyé(s) vers Criabot. {$a->failed} échec(s), {$a->skipped} ignoré(s).';
$string['sync_repush_bots_none'] = 'Aucune configuration de bot renvoyée. Vérifiez les liens de modèles, les intentions publiées et Criabot sur la page État de synchronisation.';
$string['sync_repush_failed_bot'] = 'Échec de l\'envoi vers Criabot pour le bot {$a->name}';
$string['sync_repush_skipped_models'] = 'Bot {$a->bot} ignoré : modèles non liés à Criadex';
$string['sync_repush_skipped_no_intents'] = 'Bot {$a->bot} ignoré : aucune intention publiée';
$string['sync_repush_more_failures'] = '…et {$a} autre(s) problème(s) de renvoi. Consultez les journaux avec le débogage activé.';
$string['sync_content_push_failed'] = 'Échec de la publication du contenu vers Criabot.';
$string['sync_content_delete_failed'] = 'Échec de la suppression du contenu dans Criabot (copie locale supprimée).';
$string['sync_index_upload_failed'] = 'Échec du téléversement du document analysé vers Criabot.';
$string['sync_auto_help'] = 'La création ou la modification d\'un modèle est envoyée automatiquement à Criadex. La création ou la modification d\'un bot (et la publication des intentions/contenus) est envoyée automatiquement à Criabot. Utilisez les actions ci-dessous uniquement pour récupérer les modèles distants, supprimer les doublons ou réparer une dérive.';
$string['sync_ragflow_ui_note'] = 'Les modèles Ragflow du locataire (par ex. GPT-5.4) sont synchronisés automatiquement dans Criadex puis dans cette liste de modèles lorsque vous ouvrez la page ou récupérez les modèles depuis l\'état de synchronisation. Vérifiez que l\'URL Ragflow, la clé API et le locataire correspondent à docker.env de Criadex/Criabot (RAGFLOW_TENANT_ID).';
$string['task_sync_models'] = 'Synchroniser les modèles Cria depuis Criadex';
$string['never'] = 'Jamais';
$string['sync_check_provider_types'] = 'Les fournisseurs locaux couvrent les types de modèles distants';
$string['sync_check_provider_types_ok'] = 'Tous les types de fournisseurs distants ont un fournisseur local correspondant.';
$string['sync_check_provider_types_missing'] = 'Fournisseurs locaux manquants pour les types : {$a}';
$string['sync_check_criabot_bots'] = 'Les bots Moodle existent sur Criabot';
$string['sync_check_criabot_bots_ok'] = 'Tous les bots publiés sont enregistrés sur Criabot.';
$string['sync_check_criabot_bots_missing'] = 'Manquants sur Criabot : {$a}';
$string['sync_missing_bot_type'] = '{$a} (type de bot manquant)';
$string['sync_check_bot_type_assigned'] = 'Tous les bots ont un type';
$string['sync_check_bot_type_assigned_ok'] = 'Chaque bot a un type sélectionné.';
$string['sync_check_bot_type_assigned_missing'] = 'Type de bot manquant pour le(s) id : {$a}';
$string['sync_check_bot_types'] = 'Types de bot configurés';
$string['sync_check_bot_types_detail'] = '{$a} type(s) de bot dans Moodle';
$string['sync_check_solution'] = 'Correctif suggéré';
$string['sync_action_open_settings'] = 'Ouvrir les paramètres du plugin';
$string['sync_action_open_models'] = 'Gérer les modèles';
$string['sync_action_cleanup_unlinked'] = 'Supprimer les modèles non liés inutilisés';
$string['sync_action_auto_repair'] = 'Réparer les problèmes courants';
$string['sync_action_manage_bot_types'] = 'Gérer les types de bot';
$string['sync_bot_edit_link'] = 'Modifier le bot {$a}';
$string['sync_solution_settings'] = 'Définissez l\'URL Criadex, l\'URL Criabot et la clé API Criadex dans les paramètres du plugin. Utilisez le nom d\'hôte Docker lorsque Cria est dans la même stack (par ex. http://criadex:25574).';
$string['sync_solution_service_unreachable'] = 'Vérifiez que le service fonctionne, que l\'URL est correcte et que le conteneur Cria peut y accéder sur le réseau Docker.';
$string['sync_solution_unlinked_models'] = 'Récupérez d\'abord les modèles depuis Criadex. Supprimez ensuite les doublons locaux sans id Criadex non utilisés par un bot.';
$string['sync_solution_unlinked_models_list'] = 'Modèles non liés : {$a}.';
$string['sync_solution_bots_model_links'] = 'Ouvrez chaque bot concerné et choisissez des modèles LLM/embedding liés à Criadex, ou synchronisez et réassignez les modèles.';
$string['sync_solution_missing_criabot_bots'] = 'Renvoyez les bots vers Criabot. En cas d\'échec, vérifiez le type, les liens de modèles et les intentions publiées.';
$string['sync_solution_missing_bot_type'] = 'Ouvrez chaque bot ci-dessous et sélectionnez un type (Factual, GenAI, etc.).';
$string['sync_solution_provider_types'] = 'Récupérez les modèles depuis Criadex pour créer automatiquement les fournisseurs locaux manquants.';
$string['sync_solution_no_bot_types'] = 'Créez au moins un type de bot avant de créer des bots.';
$string['sync_solution_ragflow_credentials'] = 'Dans les paramètres du plugin, définissez l\'URL Ragflow, la clé API (UI Ragflow) et le locataire (requête api_token). Les mêmes valeurs doivent être dans docker.env de Criadex/Criabot.';
$string['sync_solution_generic'] = 'Consultez le détail et utilisez les actions de réparation sur cette page. État : {$a}';
$string['sync_cleanup_unlinked_success'] = '{$a->removed} modèle(s) non lié(s) inutilisé(s) supprimé(s). {$a->blocked} encore utilisé(s) ou non supprimable(s) automatiquement.';
$string['sync_cleanup_unlinked_blocked_detail'] = 'Ces modèles non liés sont encore référencés par des bots : {$a}';
$string['sync_local_dedupe_removed'] = '{$a} doublon(s) local(aux) de modèle supprimé(s).';
...
$string['ragflow_url'] = 'URL Ragflow';
$string['ragflow_url_help'] = 'URL de base pour les contrôles de santé et d\'API Ragflow (par ex. http://ragflow:9380 dans Docker).';
$string['ragflow_api_key'] = 'Clé API Ragflow';
$string['ragflow_api_key_help'] = 'Optionnel. Copiez depuis l\'interface Ragflow. Utilisé par la page État de sync. Doit correspondre à RAGFLOW_API_KEY dans docker.env de Criadex/Criabot.';
$string['ragflow_tenant_id'] = 'Locataire Ragflow';
$string['ragflow_tenant_id_help'] = 'Optionnel. Id locataire de 32 caractères (table api_token Ragflow). Doit correspondre à RAGFLOW_TENANT_ID dans docker.env de Criadex/Criabot.';
