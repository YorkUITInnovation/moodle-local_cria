...
$string['sync_ragflow_ui_note'] = 'Le locataire, les clés API, les bases de connaissances et les paramètres de graphe sont gérés dans l\'interface Ragflow. Utilisez cette page pour la synchronisation Cria ↔ Criadex ↔ Criabot.';
...
$string['ragflow_url_help'] = 'URL de base de l\'API Ragflow pour les vérifications de disponibilité uniquement. Le locataire et les clés API sont gérés dans Ragflow, pas ici.';
