...
$string['sync_check_local_models_detail'] = 'Liés : {$a->linked}, non liés : {$a->unlinked}, distants : {$a->remote}';
...
$string['sync_ragflow_ui_note'] = 'Copiez la clé API et le locataire Ragflow depuis l\'interface Ragflow (ou docker env) dans les paramètres Cria pour les valider ici. Criadex et Criabot doivent utiliser les mêmes valeurs dans leurs fichiers docker.env.';
