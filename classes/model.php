...
class model extends crud
{
    ...
    {
        // Delete model from criadex
        $criadex_model_id = $this->get_criadex_model_id();
        $criadex_model_type = $this->get_provider_type();
        $result = \local_cria\criadex::delete_model($criadex_model_id, $criadex_model_type);
