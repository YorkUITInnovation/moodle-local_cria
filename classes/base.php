...
class base
{
    ...
    public static function loadJQueryJS()
    {
        ...
        $strings = $stringman->load_component_strings('local_cria', current_language());

        $PAGE->requires->js(new \moodle_url('https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js'), true);
